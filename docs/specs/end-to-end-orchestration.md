...
13. Agent Machine writes deterministic handoff evidence to the runner-owned PR/MR body and posts Linear Handoff comments with behavior-contract evidence.
