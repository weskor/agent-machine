...
- Before final handoff side effects, the runner writes `handoff_pending` progress with the PR URL and review result. Current inline execution completes handoff immediately after writing that state; future handoff workers may claim the same boundary.
