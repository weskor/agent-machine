...
- **Branch and PR ownership:** verify the expected workspace branch, base branch, configured repository, Agent Machine ownership, author/commit-author policy, and issue identifier mapping.
