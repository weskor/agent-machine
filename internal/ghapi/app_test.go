...
func TestAppIdentityFromConfigSlugFallsBackToEnvironment(t *testing.T) {
	t.Setenv("GITHUB_APP_SLUG", "env-bot")

	identity := AppIdentityFromConfigSlug("")
...
func TestAppIdentityFromConfigSlugPrefersConfigSlug(t *testing.T) {
	t.Setenv("GITHUB_APP_SLUG", "env-bot")

	identity := AppIdentityFromConfigSlug("config-bot")
